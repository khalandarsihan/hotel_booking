...
const QuickActions = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown Menu */}
      {isDropdownOpen && (
        <div className="quick-actions-dropdown absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-md shadow-lg z-50 py-1 ring-1 ring-black ring-opacity-5">
          <button
            onClick={() => openModal('new-booking')}
            className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-amber-100 hover:bg-amber-50 dark:hover:bg-slate-700 flex items-center"
          >
          ...
          <button
            ...
            className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-amber-50 dark:hover:bg-gray-600 flex items-center"
          >
